...
import com.example.a623.databinding.FragmentHomBinding
...
class HomFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentHomBinding.inflate(layoutInflater,container,false)

        binding.btnAddtaom.setOnClickListener {
            findNavController().navigate(R.id.action_homFragment_to_addFragment)
        }

        binding.btnMenu.setOnClickListener {
            findNavController().navigate(R.id.action_homFragment_to_menuFragment)
        }
